...
export const ALCHEMY_MUMBAI_API_KEY = process.env.ALCHEMY_MUMBAI_API_KEY;

export const API_KEY = IS_LINEA ? INFURA_API_KEY : ALCHEMY_MUMBAI_API_KEY

export const LINEA_GOERLI_INFURA_RPC = process.env.LINEA_GOERLI_INFURA_RPC;

export const MUMBAI_ALCHEMY_RPC = process.env.MUMBAI_ALCHEMY_RPC;

export const RPC = IS_LINEA ? LINEA_GOERLI_INFURA_RPC : MUMBAI_ALCHEMY_RPC

export const ARTHUR_ROUTER_ADDRESS_LINEA_TESTNET =
  process.env.ARTHUR_ROUTER_ADDRESS_LINEA_TESTNET ||
  '0x90C163cf7C29C449548EF605545d618009F1C74A';

export const ARTHUR_FACTORY_ADDRESS_LINEA_TESTNET =
  process.env.ARTHUR_FACTORY_ADDRESS_LINEA_TESTNET ||
  '0x95D37Feb6e4Df0F1d17DcB80A755f8DAb849C71F';

export const ARTHUR_ROUTER_ADDRESS_MUMBAI =
  process.env.ARTHUR_ROUTER_ADDRESS_MUMBAI ||
  '0x764EcF27DF3df771D1c79f48A05aB18d2b6BBa10';

export const ARTHUR_FACTORY_ADDRESS_MUMBAI =
  process.env.ARTHUR_FACTORY_ADDRESS_MUMBAI ||
  '0x943931387b8659A74752c8D7B890870899b4Fdaf';

export const ARTHUR_FACTORY_ADDRESS = IS_LINEA ? ARTHUR_FACTORY_ADDRESS_LINEA_TESTNET : ARTHUR_FACTORY_ADDRESS_MUMBAI

export const ARTHUR_ROUTER_ADDRESS = IS_LINEA ? ARTHUR_ROUTER_ADDRESS_LINEA_TESTNET : ARTHUR_ROUTER_ADDRESS_MUMBAI
...
export const CHAINS_TOKENS_LIST = IS_LINEA ? LINEA_TESTNET_TOKENS_LIST : MUMBAI_TESTNET_TOKENS_LIST

// export const CHAINS_TOKENS_LIST = {
//   [lineaTestnet.id]: LINEA_TESTNET_TOKENS_LIST,
//   [polygonMumbai.id]: MUMBAI_TESTNET_TOKENS_LIST,
// };
