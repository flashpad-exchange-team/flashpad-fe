...
export const ARTHUR_API_URL = process.env.NEXT_PUBLIC_ARTHUR_API_URL || 'https://testnet-api.arthur.exchange';
...
export const ARTHUR_ROUTER_ADDRESS_LINEA_TESTNET =
  ...
  '0x5dcC77799aA55207c3A69D63FfB706463cd834B8';
...
export const POSITION_HELPER_ADDRESS_LINEA_TESTNET =
  ...
  '0x9B0Abaa3Ab34f4C154f1Ada16C2e2aCE463b2bF8';
