...
export const IS_LINEA = process.env.NEXT_PUBLIC_IS_LINEA ? process.env.NEXT_PUBLIC_IS_LINEA === 'true' : true;
...
export const LINEA_GOERLI_INFURA_RPC = process.env.NEXT_PUBLIC_LINEA_GOERLI_INFURA_RPC;
...
export const ARTHUR_TOKEN_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_ARTHUR_TOKEN_ADDRESS_MUMBAI || '0x9F423958b0e02d6C60D1714a37bc627C23C7d048';

export const X_ARTHUR_TOKEN_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_X_ARTHUR_TOKEN_ADDRESS_MUMBAI || '0xB0B291F942C0f71F6E9b02fd038BC4e8cEac3965';

export const ARTHUR_MASTER_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_ARTHUR_MASTER_ADDRESS_MUMBAI || '0x226596f693F12FF580A832b047c66FECC5397d25';

export const MERLIN_POOL_FACTORY_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_MERLIN_POOL_FACTORY_ADDRESS_MUMBAI || '0x95D37Feb6e4Df0F1d17DcB80A755f8DAb849C71F';

export const NFT_POOL_FACTORY_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_NFT_POOL_FACTORY_ADDRESS_MUMBAI || '0x3DE501F374fd285C61E96F1039be564438D3eA33';

export const YIELD_BOOSTER_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_YIELD_BOOSTER_ADDRESS_MUMBAI || '0x47474a6B2a0514055b90C9a0F919A0d9f1FF1722';

export const POSITION_HELPER_ADDRESS_MUMBAI = process.env.NEXT_PUBLIC_POSITION_HELPER_ADDRESS_MUMBAI || '0x90C163cf7C29C449548EF605545d618009F1C74A';
...
export const DEFAULT_SLIPPAGE = process.env.NEXT_PUBLIC_DEFAULT_SLIPPAGE || '0.5';
export const DEFAULT_DEADLINE = process.env.NEXT_PUBLIC_DEFAULT_DEADLINE || '10';
