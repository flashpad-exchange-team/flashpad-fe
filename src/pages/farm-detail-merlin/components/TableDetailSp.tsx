...
const TableDetailSp: React.FC<TableDetailProps> = () => {
  ...
  return (
    <div className="overflow-x-auto mt-8">
      <div className="min-w-full bg-[#00000080] pt-3">
        <div
          className="py-4 px-4 cursor-pointer"
          onClick={() => router.push('/farm-detail-merlin')}
        >
          <p className="text-[14px] font-bold text-left w-[120px] ">Pool</p>
          <div className="flex justify-between pt-2">
            <div className="flex space-between text-[12px] text-[#344054]">
              Total value locked
            </div>
            <div>$482.58K</div>
          </div>
          ...
          <div className="flex justify-between pt-2">
            <div className="text-[12px] text-[#344054]">Pending rewards #1</div>
        ...
        <div
          ...
          onClick={() => router.push('/farm-detail-merlin')}
        >
          <p className="text-[14px] font-bold text-left w-[120px] ">Status</p>
          <div className="flex justify-between pt-2">
          ...
          <div className="flex justify-between pt-2">
            <div className="text-[12px] text-[#344054]">End in</div>
            <div>7 months 1 day</div>
          </div>
        </div>
        <div
          ...
          onClick={() => router.push('/farm-detail-merlin')}
        >
          <p className="text-[14px] font-bold text-left w-[120px] ">
            Authorizations
          </p>
          <div className="flex justify-between pt-2">
          ...
          <div className="flex justify-between pt-2">
            <div className="text-[12px] text-[#344054]">Deposits end time</div>
            <div className="text-[#F04438] font-semibold">Disabled</div>
          </div>
          <div className="flex justify-between pt-2">
